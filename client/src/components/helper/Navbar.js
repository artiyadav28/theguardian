      ...
      <Toolbar />
        ...
        >
          ...
          <Menu iconShape='square' style={{color:"black"}} className="styled-text" >
              ...
              <MenuItem active={path.includes('/trustscore')} style={{backgroundColor:(!path.includes('/trustscore')?"white":"#EDEDED")}} icon={<PercentIcon />}>Trust Score <Link to="/legitPercent"/></MenuItem>
